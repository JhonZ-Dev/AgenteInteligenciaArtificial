def robotDeRiego():
  ...
  RECUERDE QUE LOS UNICOS VALORES QUE SE ACEPTAN SON A, B, C Y  D''')
    ...
    while seleccion == True:
      ubicacionLote = input("Digite donde se encuentra el robot:  ") 
    ...
    #Un elif para controlar bloques de codigo 
      elif ubicacionLote == 'B':
          #Si el usuario digita B
        ...
        estadoLoteA = input("Digite el estado del lote A:    ") #Digita el estado del lote A
        estadoLoteB = input("Digite el estado del lote B:    ") #Digita el estado del lote C
    ...
    #Aqui empieza la preogramacion para el LOTE C 
        ...
        if estadoDelLoteC == '0':
            ...
            if estadoLoteA == '1': #Si el usuario digita 1 se ejecuta el siguiente bloque de codigo
                ...
                print("Lote B ya esta regado") #Se muestra por pantalla que el lote C ya esta regado
      elif ubicacionLote == 'D':
        print("****Programa Finalizado*******")
        print("|--------------------------------|")
        print("|--------------------------------|")
        print("|****Sin acciones que realizar***|")
        print("|--------------------------------|")
        print("|--------------------------------|")
        seleccion = False
      
      print("OBJETIVO DEL ESTADO ES:      " )
